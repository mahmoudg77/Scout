...
CREATE TABLE IF NOT EXISTS `setting` (
  ...
  `group` varchar(100) NOT NULL DEFAULT 'General Setting',
  PRIMARY KEY (`id`),
  KEY `lang` (`lang`),
  KEY `group` (`group`)
...
INSERT INTO `setting` (`id`, `name`, `hint`, `key`, `value`, `type`, `availables`, `lang`, `group`) VALUES
(1, 'Site name', 'Title of your website', 'site_name', 'Arabece', 1, '', 'en', 'General'),
(2, 'إسم الموقع', 'Title of your website', 'site_name', 'تربية الطفولة المبكرة العربية', 1, '', 'ar', 'General'),
(3, 'Default email البريد الإلفتراضي ', 'Website email you can use any place', 'emails_default', 'info@arabece.com', 1, '', '*', 'General'),
(4, 'No-replay email بريد الإشعارات', 'This email for message you not follow up it''s response ', 'emails_noreplay', 'no-replay@arabece.com', 1, '', '*', 'General'),
(5, 'About Us', 'about_us', 'about_us', '', 8, '', 'en', 'General'),
(77, 'Notes', 'Notes', 'site_notes', '', 1, '', 'en', 'General'),
(78, 'نبذة عن الموقع', 'نبذة عن الموقع', 'site_notes', 'يشرفنا خدمة جميع دول الخليج العربي: المملكة العربية السعودية، الإمارات العربية المتحدة، قطر، عمان، البحرين، والكويت.', 1, '', 'ar', 'General'),
(9, 'Max image size (KB)', '', 'max_image_size', '100', 1, '', '*', 'Posts'),
(6, 'من نحن', 'about_us', 'about_us', '<p> </p>\n\n<p dir="RTL" style="text-align:center"><span style="font-size:28px"><u><strong><span style="color:red; font-family:al-mohanad bold">من نحن</span></strong></u></span></p>\n\n<p dir="RTL" style="text-align:center"><span style="font-size:22px"><span style="font-family:al-mohanad">متخصصون و رائدون في تربية الطفولة المبكرة (0: 8 سنوات) لتقديم الحلول، الاستشارات، الخدمات، والتدريب للمؤسسات، والهيئات، الحضانات، الروضات، والوالدين &nbsp;لدعم تربية الطفل وتعلمه من الميلاد وحتى ثماني سنوات. وتقديم الاستشارات والخدمات البحثية للباحثين في مجال تربية الطفولة المبكرة. نعمل تحت إشراف د. محمد خليفة إسماعيل، خبير تربية الطفولة المبكرة، ومراجع الاعتماد والجودة لدى الجمعية الوطنية الأمريكية لتربية الأطفال الصغار NAEYC</span></span></p>\n\n<p dir="RTL" style="text-align:center"> </p>', 8, '', 'ar', 'General'),
(73, 'العنوان', 'العنوان', 'site_address', 'الرياض - المملكة العربية السعودية', 1, '', 'ar', 'General'),
...
(43, 'Allow write post', '', 'allow_write_post', 'Yes', 3, '', '*', 'Student'),
(44, 'Allow write event', '', 'allow_write_event', 'No', 3, '', '*', 'Student'),
(45, 'Allow write article', '', 'allow_write_article', 'No', 3, '', '*', 'Student'),
(46, 'Allow write comment', '', 'allow_write_comment', 'Yes', 3, '', '*', 'Student'),
(47, 'Using editor', '', 'editor', 'No', 3, '', '*', 'Posts'),
(48, 'Using editor', '', 'editor', 'Yes', 3, '', '*', 'Articles'),
(49, 'Allow follow', '', 'allow_follow', 'No', 3, '', '*', 'Student'),
(50, 'Can followed', '', 'can_followed', 'No', 3, '', '*', 'Student'),
...
(57, 'Activation periods (Day)', '', 'activiation_period', '10', 1, '', '*', 'Student'),
(58, 'On expired', '', 'expired_action', 'Suspense Account', 4, '{1 as id,''No Action'' as name union all select 2 as id,''Suspense Account'' as name union all select 3 as id,''Denied Post, event and article'' as name}', '*', 'Student'),
...
(62, 'وصف الموقع', 'Description of your website', 'site_desc', 'متخصصون في تقديم تقديم الحلول، الاستشارات، الخدمات، والتدريب للمؤسسات، والهيئات، الحضانات، الروضات، والوالدين  لدعم تربية الطفل وتعلمه من الميلاد وحتى ثماني سنوات', 1, '', 'ar', 'General'),
...
(64, 'الكلمات الدلالية', 'Keywords of your website', 'site_key', 'تربية الطفولة المبكرة- الطفولة- رياض الأطفال- الحضانات-طفل ماقبل المدرسة', 1, '', 'ar', 'General'),
(65, 'Site Image لوجو الموقع', 'Image of your website', 'site_image', '//arabece.web-egy.com/images/logo2.png', 1, '', '*', 'General');
