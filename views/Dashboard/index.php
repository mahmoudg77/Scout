...
<!--<section class="content container-fluid tab-pane fade" id="Forms">
  ...
  <div id="TeamR" class="tab-pane fade in active">
...
<section class="content container-fluid tab-pane fade" id="Approvels">
  <ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#RUsers">Menu 1</a></li>
    <li><a data-toggle="tab" href="#RTeam">Menu 2</a></li>
  </ul>
  <div class="tab-content">
    <div id="RUsers">
