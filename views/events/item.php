...
<div class="container">
	<div class="item active">
		<img src="<?=$data->Images[0]->original?>" alt="Los Angeles" style="width:100%;">
		<div class="carousel-caption">
			<h1 class="Ename"><?=$data->tittle?></h1>
			<a id="interA" title="Attend"><i id="interest" class="fa fa-star-o fa-4x" aria-hidden="true"></i></a><br>
			<span><?=$data->tag?></span>
			<!--Add to attend-->
		</div>
	</div>
