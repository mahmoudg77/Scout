                ...
                <div class="item">
                    <div class="features-item">
                        ...
                        <div class="col-md-6 feature-media wow fadeInUp" data-wow-duration="500ms">
                            <img src="<?=assets("img/blog/3D-beach-art.jpg")?>" alt="3D Beach Art | Meghna" class="img-responsive" />
                        </div>
                        <!-- /features media -->
...
<section id="showcase">
            ...
            <div class="col-lg-12">
                ...
                <div class="portfolio-filter clearfix">
                    <ul class="text-center">
                        <li>
                            <a href="javascript:void(0)" class="filter" data-filter="all">All</a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="filter" data-filter=".app">Mobile App</a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="filter" data-filter=".web">Web Design</a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="filter" data-filter=".photoshop">Photoshop</a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="filter" data-filter=".illustrator">Illustrator</a>
                        </li>
                    </ul>
                </div>
                <!-- /portfolio item filtering -->
    ...
    <div class="portfolio-item-wrapper wow fadeInUp" data-wow-duration="500ms">
        <ul id="og-grid" class="og-grid">
            ...
            <li class="mix app">
                <a href="javascript:void(0)" data-largesrc="<?=assets("img/portfolio/portx1.jpg")?>" data-title="Azuki bean" data-description="Swiss chard pumpkin bunya nuts maize plantain aubergine napa cabbage soko coriander sweet pepper water spinach winter purslane shallot tigernut lentil beetroot.">
                    <img src="<?=assets("img/portfolio/portx1.jpg")?>" alt="Meghna" />
            ...
            <!-- single portfolio item -->
            <li class="mix web">
                <a href="javascript:void(0)" data-largesrc="<?=assets("img/portfolio/portx1.jpg")?>" data-title="Veggies sunt bona vobis" data-description="Komatsuna prairie turnip wattle seed artichoke mustard horseradish taro rutabaga ricebean carrot black-eyed pea turnip greens beetroot yarrow watercress kombu.">
                    <img src="<?=assets("img/portfolio/portx1.jpg")?>" alt="Meghna" />
                    <div class="hover-mask">
            ...
            <li class="mix photoshop">
                <a href="javascript:void(0)" data-largesrc="<?=assets("img/portfolio/portx1.jpg")?>" data-title="Dandelion horseradish" data-description="Cabbage bamboo shoot broccoli rabe chickpea chard sea lettuce lettuce ricebean artichoke earthnut pea aubergine okra brussels sprout avocado tomato.">
                    <img src="<?=assets("img/portfolio/portx1.jpg")?>" alt="Meghna" />
                    <div class="hover-mask">
            ...
            <article class="col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp" data-wow-duration="200ms">
                <div class="pricing">
                    ...
                    <div class="price-title">
                        ...
                        <p>
                            From
                            <strong class="value">$99</strong>month
                        </p>
                    </div>
                    <!-- /plan name & value -->
            ...
            <article class="col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="400ms">
                <div class="pricing">
                    ...
                    <div class="price-title">
                        ...
                        <p>
                            From
                            <strong class="value">$149</strong>month
                        </p>
                    </div>
                    <!-- /plan name & value -->
            ...
            <article class="col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="600ms">
                <div class="pricing">
                    ...
                    <div class="price-title">
                        ...
                        <p>
                            From
                            <strong class="value">$199</strong>month
                        </p>
                    </div>
                    <!-- /plan name & value -->
            ...
            <article class="col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="750ms">
                <div class="pricing kill-margin-bottom">
                    ...
                    <div class="price-title">
                        ...
                        <p>
                            From
                            <strong class="value">$299</strong>month
                        </p>
                    </div>
                    <!-- /plan name & value -->
